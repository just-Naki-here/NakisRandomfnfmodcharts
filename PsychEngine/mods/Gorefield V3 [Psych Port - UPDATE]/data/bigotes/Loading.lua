...
makeLuaSprite('LoadBG', 'loadingscreens/pantalla_de_carga_05', -300, 0)
...
screenCenter('LoadBG', 'y')

makeAnimatedLuaSprite('Song', 'loadingscreens/BIGOTES_CARGA_05', 470, -220)
luaSpriteAddAnimationByPrefix('Song', 'idle', 'BIGOTES CARGA 05', 24, true) 
setObjectCamera('Song', 'other')
addLuaSprite('Song', true);
setProperty('Song.scale.x', '0.6')
setProperty('Song.scale.y', '0.6')
