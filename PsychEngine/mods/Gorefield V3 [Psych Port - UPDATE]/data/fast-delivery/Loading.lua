...
makeLuaSprite('LoadBG', 'loadingscreens/pantalla_azul_LASAGNA_06', 0, 0)
...
makeAnimatedLuaSprite('Song', 'loadingscreens/LASAGNA_CARGA_01', 650, -190)
luaSpriteAddAnimationByPrefix('Song', 'idle', 'LASAGNA CARGA 01', 24, true) 
