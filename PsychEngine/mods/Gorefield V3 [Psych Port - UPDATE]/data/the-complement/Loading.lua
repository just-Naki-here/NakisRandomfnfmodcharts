...
makeLuaSprite('LoadBG', 'loadingscreens/pantalla_azul_ultra_G_11', 0, 0)
...
makeAnimatedLuaSprite('Song', 'loadingscreens/pantallas_de_carga', 450, -150)
luaSpriteAddAnimationByPrefix('Song', 'idle', 'ULTRA G CARGA 01', 24, true) 
