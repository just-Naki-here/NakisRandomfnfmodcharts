...
makeLuaSprite('LoadBG', 'loadingscreens/loadingbg4', 0, -244)
...
makeAnimatedLuaSprite('Song', 'loadingscreens/ARMA_CARGA_0', 650, -100)
luaSpriteAddAnimationByPrefix('Song', 'idle', 'PISTOLA CARGA', 24, true) 
