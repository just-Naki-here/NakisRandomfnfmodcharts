...
moveY = 37.5
function onCreate()
createInstance('lluvia', 'flixel.addons.display.FlxBackdrop', {})
loadGraphic('lluvia', 'stages/cryfield/lluvia_2')
setProperty('lluvia.velocity.y', 590)
addInstance('lluvia', true)
scaleObject('lluvia', 1, 1)
updateHitbox('lluvia')
setProperty('lluvia.alpha', 0.2)


makeLuaSprite('healthBack', 'stages/cryfield/CONVENCIMIENTO_BAR', 1187, 0)
addLuaSprite('healthBack', true)
scaleObject('healthBack', 0.21, 0.21)
setObjectCamera("healthBack", 'hud');
screenCenter('healthBack', 'y')

makeLuaSprite('healthNO1', 'stages/cryfield/C_NO_BAR', 1228, 168)
addLuaSprite('healthNO1', true)
scaleObject('healthNO1', 0.3, 0.21)
setObjectCamera("healthNO1", 'hud');

makeLuaSprite('health', 'stages/cryfield/C_BAR', 1228, 168)
addLuaSprite('health', true)
scaleObject('health', 0.3, 0.21)
setObjectCamera("health", 'hud');


makeAnimatedLuaSprite('icons1', 'icon-Animated/nermal', 1181, 587)
...
setProperty('icons1.scale.x', '0.75')
setProperty('icons1.scale.y', '0.75')
setProperty('icons1.y',getProperty('icons1.y') + (downscroll and - 567 or -10))

makeAnimatedLuaSprite('icons2', 'icon-Animated/monsterfield', 1145, -20)
...
setProperty('icons2.flipX', true)
setProperty('icons2.scale.x', '0.75')
setProperty('icons2.scale.y', '0.75')
setProperty('icons2.y',getProperty('icons2.y') + (downscroll and 577 or -20))
...
setProperty('introSoundsSuffix','-cry')
...
function onCountdownTick(counter)
	if counter == 1 then
loadGraphic('countdownReady','countdowns/cry/ReadyCryfield')
runTimer('1',0.12)
 elseif counter == 2 then
  loadGraphic('countdownSet','countdowns/cry/SetCryfield')
  runTimer('2',0.12)
elseif counter == 3 then

 loadGraphic('countdownGo','countdowns/cry/Cry')
runTimer('3',0.12)
	end
