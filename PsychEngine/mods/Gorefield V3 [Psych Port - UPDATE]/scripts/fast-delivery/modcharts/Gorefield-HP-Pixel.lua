...
function onCreatePost()
    ...
    loadGraphic('icons1', 'icons/icon-bf-pixel', 150)
    ...
    loadGraphic('icons2', 'icons/icon-lasagnaboy-pixel', 150)
    setObjectCamera('icons2', 'hud')
    addLuaSprite('icons2')
 
    makeLuaSprite('icons2Cat', nil, getProperty('iconP2.x') + 0, getProperty('iconP2.y') - 0)
    loadGraphic('icons2Cat', 'icons/icon-lasagnacat-pixel', 150)
    setObjectCamera('icons2Cat', 'hud')
    addLuaSprite('icons2Cat')
    setProperty('icons2Cat.visible', false)

makeLuaSprite('health', 'pixelUI/healthbar_pixel', getProperty('healthBar.x'), getProperty('healthBar.y'))
...
setProperty('icons2Cat.x', getProperty('iconP1.x') + -130)

setProperty("icons2Cat.alpha", getProperty("icons2.alpha"))
...
local h = getHealth() <= 0.35
    ...
    loadGraphic('icons1', 'icons/icon-bf-pixel', 150)
    addAnimation('icons1', 'icons/icon-bf-pixel', {h and 1 or 0, h and 0 or 1}, 0, true)

local hh = (getProperty('healthBar.percent') > 80)

    loadGraphic('icons2', 'icons/icon-lasagnaboy-pixel', 150)
    addAnimation('icons2', 'icons/icon-lasagnaboy-pixel', {hh and 1 or 0, hh and 0 or 1}, 0, true)
    loadGraphic('icons2Cat', 'icons/icon-lasagnacat-pixel', 150)
    addAnimation('icons2Cat', 'icons/icon-lasagnacat-pixel', {hh and 1 or 0, hh and 0 or 1}, 0, true)
end
