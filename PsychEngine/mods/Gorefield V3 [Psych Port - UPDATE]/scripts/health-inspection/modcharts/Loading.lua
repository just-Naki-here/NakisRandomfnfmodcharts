...
makeLuaSprite('LoadBG', 'loadingscreens/pantalla_azul_LASAGNA_07', 0, 0)
...
makeAnimatedLuaSprite('Song', 'loadingscreens/LASAGNA_CARGA_2', 600, 0)
luaSpriteAddAnimationByPrefix('Song', 'idle', 'LASAGNA CARGA 2', 24, true) 
