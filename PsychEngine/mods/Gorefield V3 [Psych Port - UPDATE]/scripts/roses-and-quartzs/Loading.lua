...
makeLuaSprite('LoadBG', 'loadingscreens/pantalla_azul_ultra_G_12', 0, 0)
...
makeAnimatedLuaSprite('Song', 'loadingscreens/ULTRA_G_CARGA_02', 550, -150)
luaSpriteAddAnimationByPrefix('Song', 'idle', 'ULTRA G CARGA 02', 24, true) 
