...
makeLuaSprite('LoadBG', 'loadingscreens/pantalla_azul_4')
...
makeAnimatedLuaSprite('Song', 'loadingscreens/BF_CARGA_04', 400, -200)
luaSpriteAddAnimationByPrefix('Song', 'idle', 'BF CARGA 04', 24, true) 
