...
function onStartCountdown()
	if not allowCountdown and loading then
   runTimer('sfx', 0.1)
...
makeLuaSprite('LoadBG', 'loadingscreens/pantalla_de_carga_cartoon', 0, 0)
...
makeAnimatedLuaSprite('Song', 'loadingscreens/CARTOON_CARGA', 500, -10)
luaSpriteAddAnimationByPrefix('Song', 'idle', 'CARTOON CARGA', 24, true) 
