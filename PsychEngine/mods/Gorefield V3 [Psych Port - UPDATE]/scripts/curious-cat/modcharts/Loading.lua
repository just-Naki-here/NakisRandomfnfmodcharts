...
makeLuaSprite('LoadBG', 'loadingscreens/loadingbg1', 0, 0)
...
makeAnimatedLuaSprite('Song', 'loadingscreens/rightloadingimage1', 380, -220)
luaSpriteAddAnimationByPrefix('Song', 'idle', 'BF 1', 24, true) 
