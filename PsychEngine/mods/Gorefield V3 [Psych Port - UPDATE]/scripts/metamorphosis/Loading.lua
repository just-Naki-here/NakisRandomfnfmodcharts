...
makeLuaSprite('LoadBG', 'loadingscreens/pantalla_azul_2', 0, 0)
...
makeAnimatedLuaSprite('Song', 'loadingscreens/rightloadingimage2', 430, -220)
luaSpriteAddAnimationByPrefix('Song', 'idle', 'GOREFIELD', 24, true) 
