...
function onStepHit()
	...
	setProperty('boyfriendGroup.visible', false);
	setProperty('gfGroup.visible', false);
    triggerEvent('Change Character', '1', 'squidward')
	xx = 390;
	ofs = 0;
	...
	if curStep == 3010 or curStep == 3042 then
	doTweenZoom('asf', 'camGame', 0.85, 0.2, 'cubeOut')
	setProperty('defaultCamZoom', 0.85)
	idk = 0.85;
	end 
	if curStep == 3026 or curStep == 3058 then
	...
	if curStep == 3122 or curStep == 3090 then
	doTweenZoom('asf', 'camGame', 0.75, 0.2, 'cubeOut')
	setProperty('defaultCamZoom', 0.75)
	idk = 0.75;
	end 
	if curStep == 3154 then
	triggerEvent('Play Animation', 'dad', 'dieol')
	triggerEvent('Change Character', '1', 'DOOMSDAY_SUICIDE')
	end
	...
	if curStep == 2874 then
	
	end
	if curStep > 2882 and curStep < 2946 then
	triggerEvent('Screen Shake', '0.25, 0.012', '0.1, 0.008')
	end
end
