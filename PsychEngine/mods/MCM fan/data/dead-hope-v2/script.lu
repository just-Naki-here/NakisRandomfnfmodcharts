...
function onEvent(n,v1,v2) --puse los eventos aqui para que el juego no vaya a 40fps xd
	...
	noteTweenX('playerx1', 4, defaultPlayerStrumX0 - 300, 0.2)
	noteTweenX('playerx2', 5, defaultPlayerStrumX1 - 300, 0.2)
	noteTweenX('playerx3', 6, defaultPlayerStrumX2 - 300, 0.2)
	noteTweenX('playerx4', 7, defaultPlayerStrumX3 - 300, 0.2)
	end
	if n == 'why-stop' then
			stops=true
			work=false
