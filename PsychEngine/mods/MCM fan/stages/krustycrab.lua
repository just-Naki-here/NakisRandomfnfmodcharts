...
function onCreatePost()
	...
	makeLuaSprite('YummerOrigin', 'background/krustycrab/YummerOrigin', 955,-50);
	scaleLuaSprite('YummerOrigin',1,1);
	setProperty('YummerOrigin.angle', 1);
...
function onEvent()
	...
	ap = math.random(0.0000001,1)
		end
		end
		
function onUpdate()

doTweenAlpha('YummerOrigin','YummerOrigin',ap,0.0000001)
	if del > 0 then
		del = del - 1
	end
	if del2 > 0 then
