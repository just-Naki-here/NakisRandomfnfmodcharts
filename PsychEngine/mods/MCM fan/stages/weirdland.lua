...
-- Stage Stuff
function onCreate()
	makeAnimatedLuaSprite('bg','background/weirdland/static', 155, 320)
	addAnimationByPrefix('bg','doors', 'doors', 24, true)
	scaleLuaSprite('bg', 0.1, 0.1);
	addLuaSprite('bg', false);
	doTweenX('44', 'bg.scale', 1, 0.000005, elapsed)
	doTweenY('4', 'bg.scale', 1, 0.000005, elapsed)
