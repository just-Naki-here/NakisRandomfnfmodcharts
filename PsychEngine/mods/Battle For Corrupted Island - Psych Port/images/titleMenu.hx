...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		newLogo = new FlxSprite().loadGraphic(Paths.image('titleMenu/leTitleBG'));
		newLogo.screenCenter(); //chnage the leTitleBG to you'r image
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['Battle For A FRIDAY NIGHT DISASTER Made By'], 15);
					#else
					createCoolText(['ZayDash Animates']);
					#end
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['Make Sure', 'To'], -40);
					#else
