...
idle_xml_name = 'leafymad idle'
left_xml_name = 'leafymad singLEFT'
down_xml_name = 'leafymad singDOWN'
up_xml_name = 'leafymad singUP'
right_xml_name = 'leafymad singRIGHT'
...
name_of_character_xml = 'leafymad'
name_of_character = 'leafymad'
name_of_notetype = 'leafynote'
