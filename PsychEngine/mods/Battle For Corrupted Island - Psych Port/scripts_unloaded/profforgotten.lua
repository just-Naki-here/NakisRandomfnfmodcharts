...
idle_xml_name = 'profily idle'
left_xml_name = 'profily singLEFT'
down_xml_name = 'profily singDOWN'
up_xml_name = 'profily singUP'
right_xml_name = 'profily singRIGHT'
imhere_xml_name = 'profily imhere'
ded_xml_name = 'profily ded'
...
name_of_character_xml = 'profily'
name_of_character = 'profily'
name_of_notetype = 'pfpnote'
name_of_notetype2 = 'null' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
function onCreatePost()
	makeAnimatedLuaSprite(name_of_character, 'characters/forgotten/' .. name_of_character_xml, x_position, y_position);
	...
	addAnimationByPrefix(name_of_character, 'ded', ded_xml_name, 24, false);
	addAnimationByPrefix(name_of_character, 'imhere', imhere_xml_name, 24, false);
	...
	setObjectOrder(name_of_character, 3);
