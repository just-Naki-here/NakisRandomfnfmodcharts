...
local warningimage = 'stages/gypso/warningimage' -- put your image in mods/images, needs to be 1280x720
local confirmed = 0
...
function onUpdate()
    ...
    if getPropertyFromClass('flixel.FlxG', 'keys.justPressed.BACKSPACE') and confirmed == 0 then
     allowCountdown = true
     confirmed = 1
