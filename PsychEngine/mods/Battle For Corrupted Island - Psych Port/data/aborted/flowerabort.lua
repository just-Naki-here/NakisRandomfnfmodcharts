...
idle_xml_name = 'flowerabort idle'
left_xml_name = 'flowerabort singLEFT'
down_xml_name = 'flowerabort singDOWN'
up_xml_name = 'flowerabort singUP'
right_xml_name = 'flowerabort singRIGHT'
...
name_of_character_xml = 'flowerabort'
name_of_character = 'flowerabort'
name_of_notetype = 'flowernote'
...
function onCreatePost()
	makeAnimatedLuaSprite(name_of_character, 'characters/abort/' .. name_of_character_xml, x_position, y_position);
