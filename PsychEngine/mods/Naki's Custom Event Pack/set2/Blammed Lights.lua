colors = {'E21E00DC', '31FD8C', 'F794F7', 'F96D63', 'FBA633'}
...
function onEvent(name, value1)
	...
	if name == 'Blammed Lights' then
		...
		if lightId > 0 then
			...
			if stage == 'weirdland' then
				doTweenColor('phillyCityLightsEventColor', 'room', colors[lightId], 0.00000001, 'quadInOut')
