-- ==================================
-- Opponent Wave Notes Modchart
-- Makes the opponent notes move in a wave pattern
-- Also makes the opponent notes slightly transparent
-- Also makes the opponent notes flip when they reach the top or bottom of the screen
-- Also adds random offsets to the opponent notes
-- Also moves the opponent notes vertically in a sine wave pattern
-- ==================================
