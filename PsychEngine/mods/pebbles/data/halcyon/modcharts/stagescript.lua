...
rainworguiElem[27] = 'therates'
	...
	makeAnimatedLuaSprite('texttoscream','halcyon/texttoscream', 520, -60)
		...
		objectPlayAnimation('texttoscream','texttoscream',true);
	...
	makeAnimatedLuaSprite('reindeer','halcyon/reindeer', 1245, -30)
		...
		objectPlayAnimation('reindeer','reindeer',true);
	...
	makeAnimatedLuaSprite('criesofscug','halcyon/criesofscug', -170, -360)
		...
		objectPlayAnimation('criesofscug','scugdies1',true)
	...
	makeAnimatedLuaSprite('wetvoid','halcyon/wetvoid', -255, -130)
		...
		objectPlayAnimation('wetvoid','wetvoid',true);
...
stepHitFuncs = {
	...
	[1040] = function()
		objectPlayAnimation('scugdetect','scugremove',true);
		haloScale(0.8)
	...
	[1296] = function()
		...
		objectPlayAnimation('microphone','micdetect',true);
		haloScale(1)
		easythere = "backInOut"
	end,
	[1320] = function()
		objectPlayAnimation('strangescribbles','pissed',true);
	end,
	[1328] = function()
	...
	[1356] = function()
		...
		objectPlayAnimation('iteratorstructure','tbh',true);
	end,
	[1392] = function()
		setProperty('bfwikipedia.alpha', 0.7)
		objectPlayAnimation('bfwikipedia','tbh lore',true);
	end,
	[1552] = function()
	haloScale(0.8)
	easythere = "elasticInOut"
	...
	objectPlayAnimation('criesofscug','scugdies2',true)
	...
	objectPlayAnimation('criesofscug','scugdies3',true)
	setProperty('defaultCamZoom', 0.58)
	cocaclowing = 0.35
	end,
	
	[2622] = function()
	objectPlayAnimation('criesofscug','scugX',true)
	...
	if shoulddocircle == true then
		if curBeat % circlestuff == 0 then
			...
			makeAnimatedLuaSprite('justcircles' .. amountofcirc, 'halcyon/justcircle', getRandomInt(350,950), getRandomInt(-40,400))
				...
				objectPlayAnimation('justcircles' .. amountofcirc,'justcircles' .. whatthing,true);
