...
public var curStageLv = 0;
public var water = new CustomShader('water');
...
function update(e) 
	if (water != null) water.iTime = Conductor.songPosition / 1000;

function onNoteCreation(e) e.note.antialiasing = false;
function onStrumCreation(e) e.strum.antialiasing = false;
// function postUpdate() camHUD.zoom = 1;