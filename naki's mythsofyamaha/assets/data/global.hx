...
function new() {
    ...
    FlxG.save.bind('MythsOfYamahaHotfix', 'MythsOfYamahaHotfix'); // its just better overall to make a new save

    // ~~~~~~~~~~~~~~~~~OPTIONS
        // _PREMEDITATED
        if (FlxG.save.data.genCrt == null) FlxG.save.data.genCrt = true; 
        if (FlxG.save.data.genBloom == null) FlxG.save.data.genBloom = true;
        if (FlxG.save.data.genDither == null) FlxG.save.data.genDither = true;
        if (FlxG.save.data.genGlitch == null) FlxG.save.data.genGlitch = true;
        ...
        if (FlxG.save.data.premedPcFuckery == null) FlxG.save.data.premedPcFuckery = true; 
        if (FlxG.save.data.premedDeaths == null) FlxG.save.data.premedDeaths = 0; 
        ...
        // _GENERAL
        if (FlxG.save.data.moyUnlockedFalse == null) FlxG.save.data.moyUnlockedFalse = false;
...
function postStateSwitch() {
    ...
    FlxG.state.add(bgTxt = new FlxSprite(0, FlxG.height*0.83).makeSolid(400,70,0xFF575757));
