function onCreatePost()
  makeLuaText('credits1', 'Composer: MarleThian', 0, getProperty('timeBar.x') - 400 , -100);
   addLuaText('credits1')
   setTextSize('credits1', 20);

   makeLuaText('credits2', 'Art: MarleThian & BurpleGuy', 0, getProperty('timeBar.x') - 400 , -100);
   addLuaText('credits2')
   setTextSize('credits2', 20);

   makeLuaText('credits3', 'Animation: MarleThian', 0, getProperty('timeBar.x') - 400 , -100);
   addLuaText('credits3')
   setTextSize('credits3', 20);

   makeLuaText('credits4', 'Chromatic: MarleThian', 0, getProperty('timeBar.x') - 400 , -100);
   addLuaText('credits4')
