...
function onStepHit()
	...
	if curStep == 512 then --you belong in a mental institution
		...
		--the fucking arms
		makeLuaSprite('arm1', 'stages/throne/arm1', -1000, -400)
		setScrollFactor('arm1', .6, .6);
		setGraphicSize('arm1', 1400, 1400);
		doTweenAngle('arm1', 'arm1', 5, 8, 'sineInOut')
	
		makeLuaSprite('arm2', 'stages/throne/arm2', 900, -500)
		setScrollFactor('arm2', .6, .6);
		setGraphicSize('arm2', 1400, 1400);
		doTweenAngle('arm2', 'arm2', 5, 8, 'sineInOut')
	
		makeLuaSprite('arm3', 'stages/throne/arm3', -1000, -1000)
		setScrollFactor('arm3', .5, .5);
		setGraphicSize('arm3', 1400, 1400);
		doTweenAngle('arm3', 'arm3', 5, 8, 'elasticInOut')
	
		makeLuaSprite('arm4', 'stages/throne/arm4', -1400, 600)
		setScrollFactor('arm4', .7, .7);
		setGraphicSize('arm4', 2000, 800);
		doTweenAngle('arm4', 'arm4', 5, 8, 'bounceInOut')
	
		makeLuaSprite('arm5', 'stages/throne/arm5', 900, -1000)
		setScrollFactor('arm5', .5, .5);
		setGraphicSize('arm5', 1400, 1400);
		doTweenAngle('arm5', 'arm5', 5, 8, 'elasticInOut')
	
		makeLuaSprite('arm6', 'stages/throne/arm6', 900, 0)
		setScrollFactor('arm6', .7, .7);
		setGraphicSize('arm6', 1400, 1400);
		doTweenAngle('arm6', 'arm6', 5, 8, 'bounceInOut')
	
		--the rest of the stage
		makeLuaSprite('parallaxRed', 'stages/throne/parallaxRedLarge', pOffsetX, pOffsetY - pHeight);
		setScrollFactor('parallaxRed', 0, 0);
		setGraphicSize('parallaxRed', pWidth * 2, pHeight * 2);
		makeLuaSprite('bottom', 'stages/throne/bottom', -1280, 900);
		setScrollFactor('bottom', 1, 1);
		makeLuaSprite('throne', 'stages/throne/throne', -100, 150);
		setScrollFactor('throne', 1, 1);
		setGraphicSize('throne', 1500, 1500);
		makeAnimatedLuaSprite('sunny', 'stages/throne/stressedSunny', 300, 405);
		setScrollFactor('sunny', 1, 1);
		setGraphicSize('sunny', 300, 450);
		addAnimationByPrefix('sunny', 'idle', 'idle', 24, true);
		setObjectOrder('sunny', 2)
		objectPlayAnimation('sunny', 'idle', true);

	
		addLuaSprite('parallaxRed', false);
		addLuaSprite('arm3', false);
		addLuaSprite('arm1', false);
		addLuaSprite('arm4', false);
		addLuaSprite('arm5', false);
		addLuaSprite('arm2', false);
		addLuaSprite('arm6', false);
